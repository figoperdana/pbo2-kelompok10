...
class Stock ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_menuItem12 = wx.MenuItem( self.m_menu7, , u"Home", wx.EmptyString, wx.ITEM_NORMAL )
...
class Edit_item ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Edit Item", pos = wx.DefaultPosition, size = wx.Size( 380,332 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
...
class Income ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Income", pos = wx.DefaultPosition, size = wx.Size( 865,611 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.limitData = wx.SpinCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS|wx.SP_WRAP, 0, 10000, 10 )
		...
		self.listCtrlTranc = wx.ListCtrl( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LC_AUTOARRANGE|wx.LC_REPORT )
		self.listCtrlTranc.SetMinSize( wx.Size( 840,480 ) )

		gSizer42.Add( self.listCtrlTranc, 0, wx.ALL, 5 )
